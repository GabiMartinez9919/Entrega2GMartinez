...
3. Ejecutar `03_seed_idea_martinez.sql` → carga los datos y muestra las validaciones finales.
4. Validar que las consultas `CALL` y `SELECT` del PDF devuelvan resultados.
